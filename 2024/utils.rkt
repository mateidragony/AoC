...
(provide lines chars rows cols day testing
...
(define (make-input-request day)
  (port->string (get-pure-port (string->url (format "https://adventofcode.com/2023/day/~a/input" day))
...
(define (testing b) ;; deprecated
  (set! day-num (if b 0 1))
  (update-input))
